      ...
      <View style={styles.container}>
        <View style={styles.header}>
          <HeaderImageScrollView
            maxHeight={180}
            minHeight={150}
            headerImage={require("../assets/images/8200class.jpeg")}
            overlayColor="green"
            renderForeground={() => (
...
const mockCard = [
  {
    ...
    imageurl: require("../assets/images/instructor.png"),
    imageHeight: "50%",
    height: 500,
  },
  {
    ...
    imageurl: require("../assets/images/dance.png"),
    height: 600,
  },
  {
    ...
    imageurl: require("../assets/images/soldiers.jpeg"),
    height: 780,
  },
];
